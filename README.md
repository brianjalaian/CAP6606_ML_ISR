...
1. Create your notebook in `notebooks/` (e.g., `notebooks/04_probabilistic_graphics.ipynb`).
2. Add a leading Markdown cell with the Colab and Kaggle launch badges:

   ```markdown
   [![Open in Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/brianjalaian/CAP6606_ml_for_intelligent_systems/blob/main/notebooks/04_probabilistic_graphics.ipynb)

   [![Open in Kaggle](https://kaggle.com/static/images/open-in-kaggle.svg)](https://kaggle.com/kernels/welcome?src=https://github.com/brianjalaian/CAP6606_ml_for_intelligent_systems/blob/main/notebooks/04_probabilistic_graphics.ipynb)
   ```
...
### 3. Enabling Thebe for Lightweight Demos
- Thebe is disabled by default (`thebe: false` in `myst.yml`).
- To opt in on a specific page, add a YAML front matter flag:
...
- See `notebooks/lightweight_demo.md` for an example page that opts in to Thebe with live code.
...
Once Pages is enabled, the course book will be available at `https://brianjalaian.github.io/CAP6606_ml_for_intelligent_systems/` and update automatically whenever `main` is updated.
